...
<html><head><META http-equiv='refresh' content='0;URL=index.html; Content-Security-Policy" content="default-src *; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline' 'unsafe-eval' http://platform.linkedin.com '></head></html>
EOF
